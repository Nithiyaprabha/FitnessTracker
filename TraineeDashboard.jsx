  ...
  return (
    <div className="trainee-page">
      ...
      <div className="bmi-form">
        ...
        {bmi && <p className='bmi'>BMI: {bmi}</p>}
      </div>
      <div className="container">
        <div className="section">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8tI2x2Qfstsy6gWb66cz55qUbFf0iL1mzyA&s" alt="Videos" />
          <div className="section-content">
            <h2>Videos</h2>
            <p>Discover a wide range of fitness videos that cater to all levels of experience. From beginner routines to advanced workouts, our video library has something for everyone.</p>
          </div>
        </div>
        <div className="section">
          ...
          <div className="section-content">
            <h2>Workouts</h2>
            <p>Our curated workout plans are designed to help you achieve your fitness goals. Whether you're looking to build muscle, lose weight, or improve your overall health, we have the right plan for you.</p>
          </div>
        </div>
        <div className="section">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZiPGpzqt5NCk90vr_0QOU7eEQEBkS7TcBMQ&s" alt="Diet Plan" />
          <div className="section-content">
            <h2>Diet Plan</h2>
            <p>Maintain a balanced diet with our expert-approved meal plans. We provide nutritious and delicious recipes that are easy to follow and help you stay on track with your fitness journey.</p>
          </div>
        </div>
      </div>
      <style>{`
        ...
        .bmi-form label, .bmi-form input, .bmi-form button {
          margin-right: 20px;
        }
        .container {
          display: flex;
